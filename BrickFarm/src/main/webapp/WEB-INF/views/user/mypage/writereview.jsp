...
<!--====== App Content ======-->
        <div class="app-content">
						...
						<div class="breadcrumb">
							<div class="breadcrumb__wrap">
								<ul class="breadcrumb__list">
									...
									<li class="is-marked"><a>리뷰 작성</a></li>
								</ul>
							</div>
						</div>
					</div>
			...
			<!--====== Section Content ======-->
                ...
                <div class="bp-detail">
                <h1 class="section__heading u-c-secondary u-s-m-b-12" >리뷰작성</h1>
                ...
                <div class="table-p__img-wrap"><img class="u-img-fluid" src="${productReviewInfo.product_main_image }" alt=""></div>
				 ...
				 <span class="table-p__name"><a href="product-detail.html">${productReviewInfo.product_name }</a></span>
				 <span class="table-p__category"><a href="shop-side-version-2.html">${productReviewInfo.product_category_name }</a></span>
              	 ...
              	 <hr style="height: 1px; border: 0; background: #E2E2E2">
                                                <form class="pd-tab__rev-f2" action="/mypage/reviewconfirm" method="post">
                      					<div class="u-s-m-b-30">
                                                    ...
                                                    <div class="rev-f2__group">
                                                        <div class="u-s-m-b-15">
                                                            ...
                                                            <textarea class="text-area text-area--primary-style" required="required" id="content" name="content" placeholder="다른 회원분에게 도움이 되는 나만의 팁을 소개해주세요. (5자 이상 500자 미만 작성)" minlength="5" maxlength="500"></textarea>
                                                            </div>
                                                   		</div>
                                                   		<!-- 이미지 업로드 영역 -->
                                                        ...
                                                        <button class="btn btn--e-transparent-brand-b-2" type="submit">등록</button>
                                                        </div>
                                                </form>
                    </div>
                </div>

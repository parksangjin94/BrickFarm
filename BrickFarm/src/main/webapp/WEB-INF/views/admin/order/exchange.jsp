...
<html>
  ...
  <body>
          ...
          <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="./exchange">교환관리</a></li>
              </ol>
            </div>
          </div>
          <div class="row">
                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="form-group mb-0" id="state-select">
                      ...
                      >
                      <label class="radio-inline mr-3"
                        ><input type="radio" name="stateSelect" value="진행중" />진행중</label
                      >
                      <label class="radio-inline mr-3"
                            ...
                            <td class="row">
                              <div class="col-5 searchControll">
                                <select class="form-control form-control-xl" id="date-select" name="dateSelect">
                                  ...
                                  <option value="E.application_date">신청날짜</option>
                                  <option value="E.process_date">진행중날짜</option>
                                  <option value="E.complete_date">완료날짜</option>
                                </select>
                                <div class="col-7">
                                  <input
                                    id="date-range"
                            ...
                            <td class="row">
                              <div class="col-3 searchControll">
                                <select id="wordSelect" class="form-control form-control-xl" name="wordSelect">
                                  ...
                                  <option value="E.post_number">운송장번호</option>
                                </select>
                              </div>
                              <div class="col-4">
                                <input
      ...
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-primary light" data-dismiss="modal" onclick="changeState('Process')">
              저장
            </button>
    ...
    ***********************************-->
    ...
    <script src="/resources/admin/js/syt/exchange.js"></script>

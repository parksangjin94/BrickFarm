...
<html>
  ...
  <body>
          ...
          <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="./cancel">취소관리</a></li>
              </ol>
            </div>
          </div>
          <div class="row">
                    ...
                    <table class="table table-responsive-md">
                      <thead>
                        <tr>
                          ...
                          <th class="wd-5">주문번호</th>
                          <th class="wd-2">상태</th>
                          <th class="wd-4">아이디</th>
                          <th class="wd-4">주문자</th>
                          <th class="wd-5">상품명</th>
                          <th class="wd-4">취소금액</th>
                          <th class="wd-2">수량</th>
                          <th class="wd-4">구매가</th>
                          <th class="wd-5">구매날짜</th>
                          <th class="wd-5">신청날짜</th>
                          <th class="wd-5">완료날짜</th>
                          <th class="wd-4">결제유무</th>
                          <th class="wd-7">사유</th>
                        </tr>
                      </thead>
                      <tbody id="inputCancelList"></tbody>
                    </table>
                  </div>
                </div>
                <!-- 페이지네이션 -->
    ...
    ***********************************-->
    ...
    <script src="/resources/admin/js/syt/cancel.js"></script>

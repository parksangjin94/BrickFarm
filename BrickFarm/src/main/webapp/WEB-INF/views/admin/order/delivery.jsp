...
<html>
  <head>
    ...
    window.onload = function () {
        ...
        // 리스트 올 클릭시 모달 정보받아서 모달 띄우기
        $(document).on("click", ".listAll", function (event) {
        	let merchant_uid = $(this).closest('tr').find('td[name=merchant_uid]').text();
	        findDetail(merchant_uid); 
	    });  
     }
    </script>
  </head>
  <body>
          ...
          <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="./delivery">배송관리</a></li>
              </ol>
            </div>
          </div>
          <div class="row">
                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="form-group mb-0" id="state-select">
                      ...
                      >
                      <label class="radio-inline mr-3"
                        ><input type="radio" name="stateSelect" value="배송준비중" />배송준비중</label
                      >
                      <label class="radio-inline mr-3"
                        ><input type="radio" name="stateSelect" value="배송대기중" />배송대기중</label
                      >
                      <label class="radio-inline mr-3"
                        ><input type="radio" name="stateSelect" value="배송중" />배송중</label
                      >
                      <label class="radio-inline mr-3"
                        ><input type="radio" name="stateSelect" value="배송완료" />배송완료</label
                      >
                    </div>
                  </div>
                  <div class="card-body">
                      ...
                      <table class="table search-table table-responsive-sm overflow-hidden">
                        <tbody>
                            ...
                            <td class="row">
                              <div class="col-5 searchControll">
                                <select class="form-control form-control-xl" id="date-select" name="dateSelect">
                                  ...
                                  <option value="O.total_complete_date">완료날짜</option>
                                </select>
                                <div class="col-8">
                                  <input
                                    id="date-range"
                          ...
                          <tr>
                            ...
                            <td class="row">
                              <div class="col-2 searchControll">
                                <select id="wordSelect" class="form-control form-control-xl" name="wordSelect">
                                  ...
                                  <option value="O.post_no">운송장</option>
                                </select>
                              </div>
                              <div class="col-5">
                                <input
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <div class="form-group mb-0">
                    <button type="button" class="btn light btn-info btn-sm" onclick="changeState('paymentwait')">
                      결제대기
                    </button>
                    <button type="button" class="btn light btn-info btn-sm" onclick="changeState('prepare')">
                      배송준비중
                    </button>
                    <button
                      type="button"
                      ...
                      onclick="openChangeDeliveryWait()"
                    >
                      배송대기중
                    </button>
                  </div>
                    ...
                    <table class="table table-responsive-md">
                      <thead>
                        <tr>
                          ...
                          <th class="text-center align-middle wd-5">배송시작일</th>
                          <th class="text-center align-middle wd-2">최종상태</th>
                          <th class="text-center align-middle wd-5">완료날짜</th>
                        </tr>
                      </thead>
                      <tbody id="inputDeliveryList"></tbody>
                    </table>
                  </div>
                </div>
                <!-- 페이지네이션 -->
      ...
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">운송장번호를 입력하세요.</h5>
            <button type="button" class="close" data-dismiss="modal">
              <span>&times;</span>
            </button>
          </div>
          <form id="deliveryWaitForm">
                ...
                <table class="table table-responsive-md">
                  <thead>
                    <tr>
                      ...
                      <th class="align-middle">주문자</th>
                      <th class="align-middle">구매가</th>
                      <th class="align-middle">메모</th>
                      <th class="align-middle">운송장번호</th>
                    </tr>
                  </thead>
                  <tbody id="modalInput"></tbody>
                </table>
              </div>
            </div>
          </form>
          <div class="modal-footer">
            <button
              ...
              data-dismiss="modal"
              onclick="changeState('deliverywait')"
            >
              저장
            </button>
    ...
    ***********************************-->
    ...
    <script src="/resources/admin/js/syt/delivery.js"></script>

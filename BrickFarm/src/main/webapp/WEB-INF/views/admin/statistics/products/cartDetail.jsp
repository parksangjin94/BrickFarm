...
<html>
  <head>
    ...
    <!--====== cartDetail.jsp 용 Js ======-->
    <script type="text/javascript" src="/resources/admin/js/kyj/statistics/products/cartDetail.js"></script>

    <script>
      $(function () {
        initOrderByColumnName('product_price');
        printEmptyTable(undefined, 7);
        printOrderBySelect();
        
        $('#inputProductValue').on('change', function (e) {
          if ($('#inputProductKey').val() == 'memberId') {
        	setParams('memberId', e.target.value);
			setParams('memberName', null);
            setParams('productCode', null);
            setParams('productName', null);
          } else if ($('#inputProductKey').val() == 'memberName') {
            setParams('memberId', null);
			setParams('memberName', e.target.value);
            setParams('productCode', null);
            setParams('productName', null);
          } else if ($('#inputProductKey').val() == 'productCode') {
          	setParams('memberId', null);
			setParams('memberName', null);
        ...
        <div class="container-fluid">
          <div class="form-head d-flex mb-3 align-items-start">
            <div class="mr-auto d-none d-lg-block">
              <h2 class="text-black font-w600 mb-0">장바구니 상세 내역</h2>
              <p class="mb-0">검색 조건과 일치하는 장바구니에 등록된 상품들의 상세 내역을 볼 수 있습니다.</p>
            </div>
          </div>
          <div class="row">
                  ...
                  <div class="table-responsive">
                    <table class="table header-border table-responsive-sm table-search-result">
                      <thead id="resultHeader">                        
                        <tr>
                          <th class="wd-5">회원아이디</th>
                          <th class="wd-4">회원이름</th>

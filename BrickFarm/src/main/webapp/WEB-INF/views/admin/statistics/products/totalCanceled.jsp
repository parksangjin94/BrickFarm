...
<html>
  <head>
    ...
    <!--====== totalCanceled.jsp 용 Js ======-->
    <script type="text/javascript" src="/resources/admin/js/kyj/statistics/products/totalCanceled.js"></script>

    <script>
      $(function () {
        initDateRangePicker();
        initDateParams();
        initOrderByColumnName('return_quantity');
        printEmptyTable(undefined, 14);
        printOrderBySelect();
        ...
        <div class="container-fluid">
          <div class="form-head d-flex mb-3 align-items-start">
            <div class="mr-auto d-none d-lg-block">
              <h2 class="text-black font-w600 mb-0">취소/반품 순위</h2>
              <p class="mb-0">지정한 기간 내에 조건과 일치하는 상품들을 판매 수량/비율 순으로 정렬하여 볼 수 있습니다.</p>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-6">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">취소/반품 수량 TOP 10</h4>
                </div>
                <div class="card-body">
                  <canvas id="totalCanceledQuantityTop10" class="style-doughnut-chart"></canvas>
                </div>
              </div>
            </div>
            ...
            <div class="col-6">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">취소/반품 비율 TOP 10</h4>
                </div>
                <div class="card-body">
                  <canvas id="totalCanceledRatioTop10" class="style-doughnut-chart"></canvas>
                </div>
              </div>
            </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">취소/반품 순위 내역</h4>
                </div>
                <div class="card-body">
                    ...
                    <table class="table header-border table-responsive-sm table-search-result">
                      <thead id="resultHeader">
                        <tr class="table-header-group">
                          <th></th>
                          <th colspan="7">구매 확정</th>
                          <th colspan="2"></th>
                          <th colspan="3">취소/반품 확정</th>
                          <th></th>
                        </tr>
                        ...
                        <tr>
                          ...
                          <th class="wd-6">총할인판매가</th>
                          <th class="wd-2">재고</th>                          
                          <th class="wd-3">주문수</th>
                          <th class="wd-3">상품수</th>
                          <th class="wd-5">결제주문수</th>
                          <th class="wd-5">결제상품수</th>
                          <th class="wd-3">주문수</th>
                          <th class="wd-3">상품수</th>
                          <th class="wd-4">환불비율</th>

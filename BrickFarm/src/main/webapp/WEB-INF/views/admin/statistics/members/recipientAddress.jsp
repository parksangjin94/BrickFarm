...
<html>
  <head>
    ...
    <!--====== recipientAddress.jsp 용 Js ======-->
    <script type="text/javascript" src="/resources/admin/js/kyj/statistics/members/recipientAddress.js"></script>
        ...
        <div class="container-fluid">
          <div class="form-head d-flex mb-3 align-items-start">
            <div class="mr-auto d-none d-lg-block">
              <h2 class="text-black font-w600 mb-0">배송 지역별 분석</h2>
              <p class="mb-0">지정한 기간 내의 배송 지역별 배송횟수, 구매확정 상품수량·금액, 취소/반품확정 상품수량·금액을 볼 수 있습니다.</p>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <canvas id="statByRecipientAddress"></canvas>
                </div>
              </div>
            </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">배송 지역별 분석 내역</h4>
                </div>
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table header-border table-responsive-sm table-search-result">
                      <thead id="resultHeader">
                        ...
                        <tr>
                          <th class="wd-9">시군구</th>
                          <th class="wd-4">배송횟수</th>

...
<html>
  <head>
    ...
    <!--====== memberGrade.jsp 용 Js ======-->
    <script type="text/javascript" src="/resources/admin/js/kyj/statistics/members/memberGrade.js"></script>
        ...
        <div class="container-fluid">
          <div class="form-head d-flex mb-3 align-items-start">
            <div class="mr-auto d-none d-lg-block">
              <h2 class="text-black font-w600 mb-0">회원 등급별 분석</h2>
              <p class="mb-0">지정한 기간 내의 회원 등급별 회원수, 총확정주문수, 구매확정 상품수량·금액, 취소/반품확정 상품수량·금액을 볼 수 있습니다.</p>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <canvas id="statByMemberGrade"></canvas>
                </div>
              </div>
            </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">회원 등급별 분석 내역</h4>
                </div>
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table header-border table-responsive-sm table-search-result">
                      <thead id="resultHeader">
                        ...
                        <tr>
                          <th class="wd-4">회원등급</th>
                          <th class="wd-3">회원수</th>
                          <th class="wd-6">총확정주문수</th>

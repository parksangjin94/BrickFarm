...
<html>
  <head>
    ...
    <!--====== hour.jsp 용 Js ======-->
    <script type="text/javascript" src="/resources/admin/js/kyj/statistics/members/hour.js"></script>
        ...
        <div class="container-fluid">
          <div class="form-head d-flex mb-3 align-items-start">
            <div class="mr-auto d-none d-lg-block">
              <h2 class="text-black font-w600 mb-0">시간별 분석</h2>
              <p class="mb-0">지정한 기간 내의 각 시간 구간별 로그인 횟수, 신규가입자, 구매확정 상품수량·금액, 취소/반품확정 상품수량·금액을 볼 수 있습니다.</p>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">시간별 분석 내역</h4>
                </div>
                <div class="card-body">
                    ...
                    <table class="table header-border table-responsive-sm table-search-result">
                      <thead id="resultHeader">
                        ...
                        <tr>
                          ...
                          <th class="wd-6">상품수</th>
                          <th class="wd-4">상품금액</th>                          

  ...
  <body>
            ...
            <div class="col-xl-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">주문 회원 조회</h4>
                </div>
                    ...
                    >
                      ...
                      <tbody>
                        <c:forEach var="member" items="${orderMember }">
                          <fmt:formatDate
                            var="order_date"
                            value="${member.order_day}"
                            pattern="yyyy-MM-dd"
                          />
                          <fmt:formatNumber
                            var="sum_purchase_money"
                            value="${member.sum_purchase_money}"
                            pattern="###,###,###"
                          />
                          <fmt:formatNumber
                            var="sum_order_count"
                            value="${member.sum_order_count}"
                            pattern="###,###,###"
                          />
                          <tr
                            data-toggle="modal"
                            data-target="#orderList"
                            onclick="showOrderList('${member.member_no}', '1')"
                          >
      ...
      <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">주문 정보 조회</h5>
    ...
    <script>
      ...
      function parsingDetailOrderInfo(data) {
        ...
        $("#member_name").html(order.member_name);
        $("#member_id").html(order.member_id);
        $("#phone_number").html(order.phone_number);
          ...
          output += `<tr>
	                		...
	                		<td>
	                			<div class="d-flex align-items-center">
	                				<img src=\${list[i].product_main_image} class="rounded-lg mr-2" width="40" alt=""/>
	                				<span class="w-space-no">\${list[i].product_name}</span>
	                			</div>
	                		</td>

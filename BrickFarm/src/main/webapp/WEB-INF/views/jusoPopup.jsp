...
function init(){
   ...
   var confmKey = "devU01TX0FVVEgyMDIzMTAyMDE1NDQyNTExNDE5MjA=";
   //var confmKey = "U01TX0FVVEgyMDIzMTExMzIwMzkxMTExNDI3MTI=";
   ...
   if(inputYn != "Y"){
      ...
      //document.form.action="https://business.juso.go.kr/addrlink/addrCoordUrl.do"; //좌표인터넷망
